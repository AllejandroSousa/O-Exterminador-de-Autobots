...
class Scoreboard():
    ...
    def prep_high_score(self):
        """Turns the maximum score into a rendered image."""
        high_score = int(round(self.stats.high_score, -1))
        high_score_str = f'{high_score:,}'
        self.high_score_image = self.font.render(high_score_str, True, self.text_color, self.oea_settings.bg_color)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(str(self.stats.level), True, self.text_color, self.oea_settings.bg_color)
    ...
    def prep_ships(self):
        """Show the spaceships left."""
        self.ships = Group()
        for ship_number in range(self.stats.ships_left):
            ship = Ship(self.oea_settings, self.screen)
